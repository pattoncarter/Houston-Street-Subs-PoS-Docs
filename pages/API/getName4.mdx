...
In this case it retrieves all menu items of category "Side"

# Parameters
This API requires no paramters to call. It can be reached using /api/getName4.

# Response
This API returns a NextResponse Object which contains a list of all items in the Houston Subs menu table of type "Side" on the database. Each one of these items is a JSON object that contains members:
