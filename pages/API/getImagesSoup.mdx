...
```
# Purpose
This API is used as a secure SQL query to retrieve all of the Soup items from the Houston Street Subs MenuImages table which contains all Soup items displayed on the client Soup.

# Parameters
This API requires no parameters to call. It can be reached using /api/getImagesSoup.
