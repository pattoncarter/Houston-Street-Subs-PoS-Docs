...
# Authentication
Users have to be Authenticated using Github to access the page. The page is whitelist only pulled from a database maintained by the managerial staff. Github isn't the most optimal authentication service, but it is what was used for this project to implement OAuth.